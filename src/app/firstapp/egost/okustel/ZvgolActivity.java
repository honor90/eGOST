...
public class ZvgolActivity extends Activity implements
ActionBar.OnNavigationListener {

	 private String[] data = new String[] { "«вукосниматели", "јктивные элементы", "ѕассивные элементы", "ќптроны", "Ёлементы коммутации", "Ёлектроакустические приборы"};	
	 
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.zvgol);
