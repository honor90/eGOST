...
public class CapacitorkpeActivity extends Activity implements
ActionBar.OnNavigationListener{
	private String[] data = new String[] { "—двоенный блок  ѕ≈", "јктивные элементы", "ѕассивные элементы", "ќптроны", "Ёлементы коммутации", "Ёлектроакустические приборы"};	
		
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.capacitor_kpe);
