...
public class SwcActivity extends Activity implements
ActionBar.OnNavigationListener {

	 private String[] data = new String[] { "Контакт", "Активные элементы", "Пассивные элементы", "Оптроны", "Элементы коммутации", "Электроакустические приборы"};	
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Look up the AdView as a resource and load a request.
		AdView dView = (AdView)this.findViewById(R.id.dView);
		AdRequest dRequest = new AdRequest.Builder().build();
		dView.loadAd(dRequest);	
