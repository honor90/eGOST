...
public class SwpushActivity extends Activity implements
ActionBar.OnNavigationListener {

	 private String[] data = new String[] {"Выключатель", "Активные элементы", "Пассивные элементы", "Оптроны", "Элементы коммутации", "Электроакустические приборы"};	
	 
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.swpush);
