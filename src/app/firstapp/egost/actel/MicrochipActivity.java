...
public class MicrochipActivity extends Activity implements
ActionBar.OnNavigationListener {

	 private String[] data = new String[] {"Микросхемы", "Активные элементы", "Пассивные элементы", "Оптроны", "Элементы коммутации", "Электроакустические приборы"};	
	 
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.microchip);
